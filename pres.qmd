...
<!---
 [<img src="https://github.com/kjhealy/england_wales_pop/raw/master/figures/eng-wa-pop-pyr-labs-opt.gif" width="500%"/>]{.pull-left} 
--->
...
![](imagenes/ipp.png){.absolute top=150 left=250 width="500" height="500"}
...
![](imagenes/interfaz_rstudio.png){.absolute top=50 left=100 width="800" height="800"}
